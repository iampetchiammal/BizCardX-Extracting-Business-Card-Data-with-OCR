...
icon = Image.open(r"C:\Users\Anbazhagan K\OneDrive\Desktop\Surya\petchi\biz_card1\icon.jpeg")
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Petchiammal",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Petchiammal*!"""})
...
with st.sidebar:
    selected = option_menu(None, ["Home","Upload & Extract","Modify"], 
                        ...
                        styles={"nav-link": {"font-size": "35px", "text-align": "left", "margin": "0px"},
                                "icon": {"font-size": "35px"},
...
if selected == "Home":
            with st.spinner("In Progress....."):
                ...
                with col1:
                    ...
                    st.markdown("#     ")
                    with st.container():
                        st.subheader(" In this streamlit web app you can upload an image of a business card and extract relevant information from it using easyOCR. You can view, modify or delete the extracted data in this app. This app would also allow users to save the extracted information into a database along with the uploaded business card image. The database would be able to store multiple entries, each with its own business card image and extracted information.")
                with col2:
                    st.markdown("#     ")
                    st.markdown("#     ")
                    image=Image.open(r"C:\Users\Anbazhagan K\OneDrive\Desktop\Surya\petchi\biz_card1\home.jpeg")
                    st.image(image,caption="Business Card",width = 600)
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            with open(os.path.join(r"C:\Users\Anbazhagan K\OneDrive\Desktop\Surya\petchi\Biz card",uploaded_card.name), "wb") as f:
